		...
		public override void Up()
		{
			CreateTable(
				...
				c => new
				{
					...
					ProductName = c.String(false, 40),
					Discontinued = c.Boolean(false),
					CategoryName = c.String(false, 15),
					SupplierID = c.Int(),
					CategoryID = c.Int(),
			...
			CreateTable(
				...
				c => new
				{
					OrderID = c.Int(false),
					ProductID = c.Int(false),
					UnitPrice = c.Decimal(false, storeType: "money"),
			...
			CreateTable(
				...
				c => new
				{
					CustomerID = c.String(false, 5, true),
					CompanyName = c.String(false, 40),
			...
			CreateTable(
				...
				c => new
				{
					CustomerTypeID = c.String(false, 10, true),
			...
			CreateTable(
				...
				c => new
				{
					TerritoryID = c.String(false, 20),
					TerritoryDescription = c.String(false, 50, true),
			...
			CreateTable(
				...
				{
					RegionID = c.Int(false),
					RegionDescription = c.String(false, 50, true)
				})
			...
			CreateTable(
				...
				{
					CompanyName = c.String(false, 40),
					Relationship = c.String(false, 9, unicode: false),
					City = c.String(maxLength: 15),
					ContactName = c.String(maxLength: 30)
				})
			...
			CreateTable(
				...
				c => new
				{
					CustomerName = c.String(false, 40),
					Salesperson = c.String(false, 31),
					OrderID = c.Int(false),
					ShipperName = c.String(false, 40),
					ProductID = c.Int(false),
					ProductName = c.String(false, 40),
					UnitPrice = c.Decimal(false, storeType: "money"),
					Quantity = c.Short(false),
			...
			CreateTable(
				...
				c => new
				{
					diagram_id = c.Int(false, true),
					name = c.String(false, 128),
					principal_id = c.Int(false),
					version = c.Int(),
					definition = c.Binary()
				})
			...
			CreateTable(
				...
				.ForeignKey("dbo.CustomerDemographics", t => t.CustomerTypeID, true)
			...
			CreateTable(
				...
				.ForeignKey("dbo.Employees", t => t.EmployeeID, true)
				.ForeignKey("dbo.Territories", t => t.TerritoryID, true)
				.Index(t => t.EmployeeID)
